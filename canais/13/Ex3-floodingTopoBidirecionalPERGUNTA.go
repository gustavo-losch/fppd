...
// 			- Funciona, podemos chamar múltiplos nodos de concorrentemente sem travamentos
...
// 			-  Se eu utilizar o mesmo protocolo de inundacao muitas mensagens serao geradas, incluindo mensagens repetidas e de forma infinita através de ciclos
